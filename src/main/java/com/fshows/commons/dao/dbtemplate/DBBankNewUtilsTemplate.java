...
public class DBBankNewUtilsTemplate {

    private static QueryRunner queryRunner;
    private static final Log LOG = LogFactory.getLog(DBBankNewUtilsTemplate.class);

    static {
        System.out.println("============init DBUtilsTemplate============");
        queryRunner = DbHelperBankNew.getQueryRunner();
    }
