...
import com.fshows.commons.dao.dbsource.DbHelperBankOld;
...
public class DBBankOldUtilsTemplate {

	private static QueryRunner queryRunner;
	private static final Log LOG = LogFactory.getLog(DBBankOldUtilsTemplate.class);

	static{
		System.out.println("============init DBUtilsTemplate============");
		queryRunner = DbHelperBankOld.getQueryRunner();
	}
