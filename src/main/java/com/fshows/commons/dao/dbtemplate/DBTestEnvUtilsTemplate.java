...
public class DBTestEnvUtilsTemplate {

    private static QueryRunner queryRunner;
    private static final Log LOG = LogFactory.getLog(DBTestEnvUtilsTemplate.class);

    static {
        System.out.println("============init DBUtilsTemplate============");
        queryRunner = DbHelperTestEnv.getQueryRunner();
    }
