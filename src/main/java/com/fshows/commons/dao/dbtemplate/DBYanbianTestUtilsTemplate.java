package com.fshows.commons.dao.dbtemplate;

import com.fshows.commons.dao.dbsource.DbHelperTestEnv;
...
public class DBYanbianTestUtilsTemplate {

    private static QueryRunner queryRunner;
    private static final Log LOG = LogFactory.getLog(DBYanbianTestUtilsTemplate.class);
    ...
    public static int update(String sql, Object[] params) {
        ...
        try {
            ...
            LOG.error("update.单条修改记录错误："+e.getMessage(), e);
        }
        return affectedRows;
    }
