...
public abstract class BaseDBTemplate {
    ...
    private static final Log LOG = LogFactory.getLog(BaseDBTemplate.class);
    ...
    public int insert(String sql, Object[] params) {
        ...
        try {
            if (params == null) {
                affectedRows = getQueryRunner().update(sql);
            } else {
                affectedRows = getQueryRunner().update(sql, params);
            }
    ...
    public long count(String sql, Object... params) {
        ...
        try {
            ...
            if (params == null) {
                num = (Number) getQueryRunner().query(sql, scalarHandler);
            } else {
    ...
    public List<Map<String, Object>> find(String sql, Object[] params) {
        ...
        try {
            if (params == null) {
                list = (List<Map<String, Object>>) getQueryRunner().query(sql, new MapListHandler());
            } else {
                list = (List<Map<String, Object>>) getQueryRunner().query(sql, new MapListHandler(), params);
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public <T> List<T> find(Class<T> entityClass, String sql, Object[] params) {
        ...
        try {
            if (params == null) {
                list = (List<T>) getQueryRunner().query(sql, new BeanListHandler(entityClass));
            } else {
                list = (List<T>) getQueryRunner().query(sql, new BeanListHandler(entityClass), params);
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public <T> T findFirst(Class<T> entityClass, String sql, Object[] params) {
        ...
        try {
            if (params == null) {
                object = getQueryRunner().query(sql, new BeanHandler(entityClass));
            } else {
                object = getQueryRunner().query(sql, new BeanHandler(entityClass), params);
            }
        } catch (SQLException e) {
    ...
    public Map<String, Object> findFirst(String sql, Object[] params) {
        ...
        try {
            if (params == null) {
                map = (Map<String, Object>) getQueryRunner().query(sql, new MapHandler());
            } else {
                map = (Map<String, Object>) getQueryRunner().query(sql, new MapHandler(), params);
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public Object findBy(String sql, String columnName, Object[] params) {
        ...
        try {
            if (params == null) {
                object = getQueryRunner().query(sql, new ScalarHandler(columnName));
            } else {
                object = getQueryRunner().query(sql, new ScalarHandler(columnName), params);
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public Object findBy(String sql, int columnIndex, Object[] params) {
        ...
        try {
            if (params == null) {
                object = getQueryRunner().query(sql, new ScalarHandler(columnIndex));
            } else {
                object = getQueryRunner().query(sql, new ScalarHandler(columnIndex), params);
            }
        } catch (SQLException e) {
            e.printStackTrace();
            LOG.error("findBy.错误" + sql, e);
    ...
    public <T> List<T> query(Class<T> beanClass, String sql, Object... params) {
        try {
            ...
            return (List<T>) getQueryRunner().query(sql, isPrimitive(beanClass) ? columnListHandler : new BeanListHandler(
                    beanClass), params);
        } catch (SQLException e) {
            e.printStackTrace();
        }
