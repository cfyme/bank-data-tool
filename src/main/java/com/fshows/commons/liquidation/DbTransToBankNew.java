...
public class DbTransToBankNew {
    ...
    public void execute() {
        ...
        logger.info("新的平台化数据批量导入 execute start");
        ...
        logger.info("新的平台化数据批量导入 execute end");
    ...
    public void executeLpliquidatorStore(ArrayList<String[]> csvFileList) {
        ...
        try {
            ...
            for (int row = 0; row < csvFileList.size(); row++) {
                ...
                String tmp = String.format("('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s'),",
    ...
    public void executeLpliquidatorStoreAuth(ArrayList<String[]> csvFileList) {
        try {
            ...
            for (int row = 0; row < csvFileList.size(); row++) {
                ...
                String tmp = String.format("('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s'),",
    ...
    public void executeLpliquidatorBank(ArrayList<String[]> csvFileList) {
        ...
        try {
            ...
            for (int row = 0; row < csvFileList.size(); row++) {
                ...
                String tmp = String.format("('%s','%s','%s','%s','%s','%s','%s'),",
